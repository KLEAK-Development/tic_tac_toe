...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = init.G;
      A._asJSObject(t1.self).addEventListener("install", A._functionToJS1(new A.main_closure()));
      A._asJSObject(t1.self).addEventListener("activate", A._functionToJS1(new A.main_closure0()));
      A._asJSObject(t1.self).addEventListener("fetch", A._functionToJS1(new A.main_closure1()));
      A._asJSObject(t1.self).addEventListener("sync", A._functionToJS1(new A.main_closure2()));
      A._asJSObject(t1.self).addEventListener("message", A._functionToJS1(new A.main_closure3()));
    },
    _onInstall() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], asset, request, response, t3, _i, exception, t1, t2, cache, $async$exception;
      var $async$_onInstall = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.JSObject;
              $async$goto = 2;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(t1.self).caches).open("tic-tac-toe-static-v1")), t2), $async$_onInstall);
            case 2:
              // returning from await.
              cache = $async$result;
              t3 = type$.nullable_Object, _i = 0;
            case 3:
              // for condition
              if (!(_i < 14)) {
                // goto after for
              ...
              asset = B.List_woi[_i];
              $async$handler = 7;
              request = A._asJSObject(new t1.Request(asset));
              $async$goto = 10;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(t1.self).fetch(request)), t2), $async$_onInstall);
            case 10:
              // returning from await.
              response = $async$result;
              $async$goto = A._asBool(response.ok) ? 11 : 12;
              break;
            case 11:
              // then
              $async$goto = 13;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(cache.put(request, response)), t3), $async$_onInstall);
            case 13:
              // returning from await.
            case 12:
              // join
            ...
            case 5:
              // after for
              $async$goto = 14;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(t1.self).skipWaiting()), t3), $async$_onInstall);
            case 14:
              // returning from await.
              // implicit return
      ...
      return A._asyncStartSync($async$_onInstall, $async$completer);
    },
    _onActivate() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t2, t3, t4, t1, cacheNames;
      var $async$_onActivate = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = init.G;
              $async$goto = 2;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(t1.self).caches).keys()), type$.JSArray_nullable_Object), $async$_onActivate);
            case 2:
              // returning from await.
              cacheNames = $async$result;
              t2 = J.get$iterator$ax(type$.List_String._is(cacheNames) ? cacheNames : new A.CastList(cacheNames, A._arrayInstanceType(cacheNames)._eval$1("CastList<1,String>"))), t3 = type$.bool;
            case 3:
              // for condition
              if (!t2.moveNext$0()) {
                // goto after for
              ...
              t4 = t2.get$current();
              $async$goto = t4 !== "tic-tac-toe-static-v1" && t4 !== "tic-tac-toe-dynamic-v1" ? 5 : 6;
              break;
            case 5:
              // then
              $async$goto = 7;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(t1.self).caches).delete(t4)), t3), $async$_onActivate);
            case 7:
              // returning from await.
            case 6:
              // join
            ...
            case 4:
              // after for
              $async$goto = 8;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(t1.self).clients).claim()), type$.nullable_Object), $async$_onActivate);
            case 8:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      return A._asyncStartSync($async$_onActivate, $async$completer);
    },
    _onFetch($event) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.JSObject),
        $async$returnValue, request, url;
      var $async$_onFetch = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              request = A._asJSObject($event.request);
              url = A._asString(request.url);
              if (A._asString(request.method) !== "GET") {
                $async$returnValue = A.promiseToFuture(A._asJSObject(A._asJSObject(init.G.self).fetch(request)), type$.JSObject);
                // goto return
                $async$goto = 1;
                break;
              }
              if (A._asString(request.mode) === "navigate") {
                $async$returnValue = A._handleNavigationRequest(request);
                // goto return
                $async$goto = 1;
                break;
              }
              if (A._shouldUseStaleWhileRevalidate(url)) {
                $async$returnValue = A._staleWhileRevalidate(request);
                // goto return
                $async$goto = 1;
                break;
              }
              $async$returnValue = A._networkFirst(request);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$_onFetch, $async$completer);
    },
    _shouldUseStaleWhileRevalidate(url) {
      var _i, ext,
        lowerUrl = url.toLowerCase();
      for (_i = 0; _i < 15; ++_i) {
        ext = B.List_9Da[_i];
        if (A.stringContainsUnchecked(lowerUrl, ext, 0))
          return true;
      }
      return false;
    },
    _staleWhileRevalidate(request) {
      return A._staleWhileRevalidate$body(request);
    },
    _staleWhileRevalidate$body(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.JSObject),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], response, exception, t1, t2, cache, cachedResponse, $async$exception;
      var $async$_staleWhileRevalidate = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.JSObject;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(t1.self).caches).open("tic-tac-toe-dynamic-v1")), t2), $async$_staleWhileRevalidate);
            case 3:
              // returning from await.
              cache = $async$result;
              $async$goto = 4;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(cache.match(request)), type$.nullable_JSObject), $async$_staleWhileRevalidate);
            case 4:
              // returning from await.
              cachedResponse = $async$result;
              if (cachedResponse != null) {
                A._updateCacheInBackground(cache, request);
                $async$returnValue = cachedResponse;
                // goto return
                $async$goto = 1;
                break;
              }
              $async$handler = 6;
              $async$goto = 9;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(t1.self).fetch(request)), t2), $async$_staleWhileRevalidate);
            case 9:
              // returning from await.
              response = $async$result;
              $async$goto = A._asBool(response.ok) ? 10 : 11;
              break;
            case 10:
              // then
              $async$goto = 12;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(cache.put(request, A._asJSObject(response.clone()))), type$.nullable_Object), $async$_staleWhileRevalidate);
            case 12:
              // returning from await.
            case 11:
              // join
      ...
      return A._asyncStartSync($async$_staleWhileRevalidate, $async$completer);
    },
    _updateCacheInBackground(cache, request) {
      var t1 = A.promiseToFuture(A._asJSObject(A._asJSObject(init.G.self).fetch(request)), type$.JSObject).then$1$1(new A._updateCacheInBackground_closure(cache, request), type$.Null),
        onError = new A._updateCacheInBackground_closure0(),
        t2 = t1.$ti,
        t3 = $.Zone__current;
      if (t3 !== B.C__RootZone)
    ...
    _networkFirst(request) {
      return A._networkFirst$body(request);
    },
    _networkFirst$body(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.JSObject),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], response, cache, cache0, cachedResponse, t1, t2, exception, $async$exception;
      var $async$_networkFirst = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.JSObject;
              $async$goto = 7;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(t1.self).fetch(request)), t2), $async$_networkFirst);
            case 7:
              // returning from await.
              response = $async$result;
              $async$goto = A._asBool(response.ok) ? 8 : 9;
              break;
            case 8:
              // then
              $async$goto = 10;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(t1.self).caches).open("tic-tac-toe-dynamic-v1")), t2), $async$_networkFirst);
            case 10:
              // returning from await.
              cache = $async$result;
              $async$goto = 11;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(cache.put(request, A._asJSObject(response.clone()))), type$.nullable_Object), $async$_networkFirst);
            case 11:
              // returning from await.
            case 9:
              // join
            ...
            case 4:
              ...
              $async$exception = $async$errorStack.pop();
              $async$goto = 12;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(init.G.self).caches).open("tic-tac-toe-dynamic-v1")), type$.JSObject), $async$_networkFirst);
            case 12:
              // returning from await.
              cache = $async$result;
              cache0 = cache;
              $async$goto = 13;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(cache0.match(request)), type$.nullable_JSObject), $async$_networkFirst);
            case 13:
              // returning from await.
              cachedResponse = $async$result;
              if (cachedResponse != null) {
              ...
              $async$returnValue = A._getOfflinePage();
              // goto return
              $async$goto = 1;
              break;
              // goto after finally
      ...
      return A._asyncStartSync($async$_networkFirst, $async$completer);
    },
    _handleNavigationRequest(request) {
      return A._handleNavigationRequest$body(request);
    },
    _handleNavigationRequest$body(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.JSObject),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], response, cache, staticCache, cachedIndex, t1, t2, exception, staticCache0, $async$exception;
      var $async$_handleNavigationRequest = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.JSObject;
              $async$goto = 7;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(t1.self).fetch(request)), t2), $async$_handleNavigationRequest);
            case 7:
              // returning from await.
              response = $async$result;
              $async$goto = A._asBool(response.ok) ? 8 : 9;
            ...
            case 8:
              // then
              $async$goto = 10;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(t1.self).caches).open("tic-tac-toe-static-v1")), t2), $async$_handleNavigationRequest);
            case 10:
              // returning from await.
              cache = $async$result;
              $async$goto = 11;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(cache.put(request, A._asJSObject(response.clone()))), type$.nullable_Object), $async$_handleNavigationRequest);
            case 11:
              // returning from await.
            case 9:
              // join
            ...
            case 4:
              ...
              t1 = init.G;
              $async$goto = 12;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(t1.self).caches).open("tic-tac-toe-static-v1")), type$.JSObject), $async$_handleNavigationRequest);
            case 12:
              // returning from await.
              staticCache0 = $async$result;
              staticCache = staticCache0;
              $async$goto = 13;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(staticCache.match(A._asJSObject(new t1.Request("/index.html")))), type$.nullable_JSObject), $async$_handleNavigationRequest);
            case 13:
              // returning from await.
              cachedIndex = $async$result;
              if (cachedIndex != null) {
                $async$returnValue = cachedIndex;
                // goto return
                $async$goto = 1;
                break;
              }
      ...
      return A._asyncStartSync($async$_handleNavigationRequest, $async$completer);
    },
    _getOfflinePage() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.JSObject),
        $async$returnValue, t2, t1, offlinePage, $async$temp1, $async$temp2;
      var $async$_getOfflinePage = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = A;
              $async$goto = 4;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(t1.self).caches).open("tic-tac-toe-static-v1")), type$.JSObject), $async$_getOfflinePage);
            case 4:
              // returning from await.
              $async$goto = 3;
              return A._asyncAwait($async$temp1.promiseToFuture($async$temp2._asJSObject($async$result.match(A._asJSObject(new t1.Request("/offline.html")))), type$.nullable_JSObject), $async$_getOfflinePage);
            case 3:
              // returning from await.
              offlinePage = $async$result;
              if (offlinePage != null) {
                $async$returnValue = offlinePage;
                // goto return
                $async$goto = 1;
                break;
              }
              t2 = type$.String;
              $async$returnValue = A._asJSObject(new t1.Response("<html><body><h1>Offline</h1><p>Please check your connection.</p></body></html>", {status: 503, statusText: "Service Unavailable", headers: A._asJSObject(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["Content-Type", "text/html"], t2, t2)))}));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$_getOfflinePage, $async$completer);
    },
    _onSync() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], request, response, exception, t1, t2, cache, requests, t3, t4, $async$exception;
      var $async$_onSync = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.JSObject;
              $async$goto = 2;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(A._asJSObject(t1.self).caches).open("tic-tac-toe-sync-queue")), t2), $async$_onSync);
            case 2:
              // returning from await.
              cache = $async$result;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(cache.keys()), type$.JSArray_nullable_Object), $async$_onSync);
            case 3:
              // returning from await.
              requests = $async$result;
              t3 = J.get$iterator$ax(type$.List_JSObject._is(requests) ? requests : new A.CastList(requests, A._arrayInstanceType(requests)._eval$1("CastList<1,JSObject>")));
              t4 = type$.bool;
            case 4:
              // for condition
              if (!t3.moveNext$0()) {
              ...
              request = t3.get$current();
              $async$handler = 7;
              $async$goto = 10;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(t1.self).fetch(request)), t2), $async$_onSync);
            case 10:
              // returning from await.
              response = $async$result;
              $async$goto = A._asBool(response.ok) ? 11 : 12;
            ...
            case 11:
              // then
              $async$goto = 13;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(cache.delete(request)), t4), $async$_onSync);
            case 13:
              // returning from await.
            case 12:
              // join
      ...
      return A._asyncStartSync($async$_onSync, $async$completer);
    },
    ...
    _updateCacheInBackground_closure: function _updateCacheInBackground_closure(t0, t1) {
      this.cache = t0;
      this.request = t1;
    },
    _updateCacheInBackground_closure0: function _updateCacheInBackground_closure0() {
    },
  ...
  A.main_closure.prototype = {
    call$1($event) {
      A._asJSObject($event).waitUntil(A.FutureOfVoidToJSPromise_get_toJS(A._onInstall()));
    },
    $signature: 1
  };
  A.main_closure0.prototype = {
    call$1($event) {
      A._asJSObject($event).waitUntil(A.FutureOfVoidToJSPromise_get_toJS(A._onActivate()));
    },
    $signature: 1
  };
  A.main_closure1.prototype = {
    call$1($event) {
      A._asJSObject($event);
      $event.respondWith(A.FutureOfJSAnyToJSPromise_get_toJS(A._onFetch($event), type$.JSObject));
    },
    $signature: 1
  };
  A.main_closure2.prototype = {
    call$1($event) {
      A._asJSObject($event);
      if (A._asString($event.tag) === "background-sync")
        $event.waitUntil(A.FutureOfVoidToJSPromise_get_toJS(A._onSync()));
    },
    $signature: 1
  };
  A.main_closure3.prototype = {
    call$1($event) {
      ...
      if (data != null)
        t1 = A.JSAnyUtilityExtension_instanceOfString(data, "Object");
      else
        t1 = false;
      if (t1) {
        A._asJSObject(data);
        if ("type" in data) {
          messageType = A._asStringQ(data.type);
          if ((messageType == null ? null : messageType) === "SKIP_WAITING")
            A._asJSObject(A._asJSObject(init.G.self).skipWaiting());
        }
      }
    },
    $signature: 1
  };
  A._updateCacheInBackground_closure.prototype = {
    call$1(response) {
      return this.$call$body$_updateCacheInBackground_closure(A._asJSObject(response));
    },
    $call$body$_updateCacheInBackground_closure(response) {
      var $async$goto = 0,
      ...
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = A._asBool(response.ok) ? 2 : 3;
              break;
            case 2:
              // then
              $async$goto = 4;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject($async$self.cache.put($async$self.request, A._asJSObject(response.clone()))), type$.nullable_Object), $async$call$1);
            case 4:
              // returning from await.
            case 3:
              // join
  ...
  A._updateCacheInBackground_closure0.prototype = {
    call$1(__wc0_formal) {
    },
    $signature: 2
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Iterable, A.CastIterator, A.Error, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.ListBase, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.NullRejectionException]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.assertInteropArgs_closure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.FutureOfJSAnyToJSPromise_get_toJS__closure, A.FutureOfVoidToJSPromise_get_toJS__closure, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.main_closure, A.main_closure0, A.main_closure1, A.main_closure2, A.main_closure3, A._updateCacheInBackground_closure, A._updateCacheInBackground_closure0]);
...
;
    ...
    B.List_9Da = makeConstList([".js", ".css", ".wasm", ".html", ".json", ".png", ".jpg", ".jpeg", ".gif", ".svg", ".ico", ".woff", ".woff2", ".ttf", ".otf"], type$.JSArray_String);
    B.List_woi = makeConstList(["/", "/index.html", "/offline.html", "/manifest.json", "/favicon.png", "/icons/Icon-192.png", "/icons/Icon-512.png", "/icons/Icon-maskable-192.png", "/icons/Icon-maskable-512.png", "/flutter_bootstrap.js", "/main.dart.js", "/canvaskit/canvaskit.js", "/canvaskit/canvaskit.wasm", "/drift_worker.js"], type$.JSArray_String);
